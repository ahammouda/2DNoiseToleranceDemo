...
%\title{Asynchronous Bottlenecks of Structured Networks}
%
%\title{Mapping the Limits of BSP:  Bounding the Performance Nearest-Neighbor Synchronizing
%  Stencils Under Arbitrary Process Runtime Nonuniformity with Asynchronous Noise}
%
